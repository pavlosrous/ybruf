...
static bool app_initialize(int argn, char *argv[])
{
  ...
  //created this because I was not sure where the server's process id is
  //from user input or it's in ybruf.h file? 
  double server_ID = 1.222; 
  fprintf(fptr, "%lf", server_ID); 
  fclose(fptr); 
